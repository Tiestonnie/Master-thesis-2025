#!/bin/bash
#SBATCH --job-name=test_shap_GDBT_member0
#SBATCH --output=/gpfs/home4/tleneman/Data/Processed_cesm2/logs/test_shap_GDBT_member0_%A_%a.out
#SBATCH --error=/gpfs/home4/tleneman/Data/Processed_cesm2/logs/test_shap_GDBT_member0_%A_%a.err
...
/home/tleneman/.conda/envs/tf-env/bin/python /gpfs/home4/tleneman/shap_analysis_GDBT.py --lead $LEAD --experiment "$EXPERIMENT"
