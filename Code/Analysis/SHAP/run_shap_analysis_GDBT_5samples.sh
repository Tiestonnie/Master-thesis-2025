#!/bin/bash
#SBATCH --job-name=test_shap_GDBT_5_samples_member0
#SBATCH --output=/gpfs/home4/tleneman/Data/Processed_cesm2/logs/test_shap_GDBT_5_samples_member0_%A_%a.out
#SBATCH --error=/gpfs/home4/tleneman/Data/Processed_cesm2/logs/test_shap_GDBT_5_samples_member0_%A_%a.err
...
EXPERIMENTS=("exp_1/exp_100.json")
LEAD_TIMES=(14)
...
/home/tleneman/.conda/envs/tf-env/bin/python /gpfs/home4/tleneman/shap_analysis_GDBT_5samples.py --lead $LEAD --experiment "$EXPERIMENT"
