...
# Verify numpy, TensorFlow, pandas, matplotlib, and scikit-learn
...
/home/tleneman/.conda/envs/tf-env/bin/python /gpfs/home4/tleneman/results_model1_v050.py --lead $LEAD --experiment "$EXPERIMENT"
echo "Python test script executed for experiment $EXPERIMENT with RMSE computation"
