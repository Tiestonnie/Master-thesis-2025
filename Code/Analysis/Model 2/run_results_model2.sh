...
# Run the script
/home/tleneman/.conda/envs/tf-env/bin/python /gpfs/home4/tleneman/results_model2.py "$EXPERIMENT"
echo "Python test and analysis script executed for experiment $EXPERIMENT"