...
# Define experiments for prototype (lead=14)
# experiments = ['exp_4/exp_400', 'exp_5/exp_500', 'exp_6/exp_600', 'exp_7/exp_700']

# Full experiment list:
# experiments = ['exp_1/exp_100', 'exp_1/exp_101', 'exp_1/exp_102', 'exp_1/exp_103', 'exp_1/exp_104', 'exp_1/exp_105', 'exp_1/exp_106', 'exp_1/exp_107', 'exp_1/exp_108', 'exp_1/exp_109', 'exp_4/exp_400', 'exp_4/exp_401', 'exp_4/exp_402', 'exp_4/exp_403', 'exp_4/exp_404', 'exp_4/exp_405', 'exp_4/exp_406', 'exp_4/exp_407', 'exp_4/exp_408', 'exp_4/exp_409', 'exp_5/exp_500', 'exp_5/exp_501', 'exp_5/exp_502', 'exp_5/exp_503', 'exp_5/exp_504', 'exp_5/exp_505', 'exp_5/exp_506', 'exp_5/exp_507', 'exp_5/exp_508', 'exp_5/exp_509', 'exp_6/exp_600', 'exp_6/exp_601', 'exp_6/exp_602', 'exp_6/exp_603', 'exp_6/exp_604', 'exp_6/exp_605', 'exp_6/exp_606', 'exp_6/exp_607', 'exp_6/exp_608', 'exp_6/exp_609', 'exp_7/exp_700', 'exp_7/exp_701', 'exp_7/exp_702', 'exp_7/exp_703', 'exp_7/exp_704', 'exp_7/exp_705', 'exp_7/exp_706', 'exp_7/exp_707', 'exp_7/exp_708', 'exp_7/exp_709', 'exp_8/exp_800', 'exp_8/exp_801', 'exp_8/exp_802', 'exp_8/exp_803', 'exp_8/exp_804', 'exp_8/exp_805', 'exp_8/exp_806', 'exp_8/exp_807', 'exp_8/exp_808', 'exp_8/exp_809', 'exp_9/exp_900', 'exp_9/exp_901', 'exp_9/exp_902', 'exp_9/exp_903', 'exp_9/exp_904', 'exp_9/exp_905', 'exp_9/exp_906', 'exp_9/exp_907', 'exp_9/exp_908', 'exp_9/exp_909']

# To scale to all lead times, use:
# experiments = [
#     'exp_1/exp_100',  # lead=14
#     'exp_4/exp_401',  # lead=21
#     'exp_5/exp_500',  # lead=28
#     'exp_6/exp_600',  # lead=35
#     'exp_7/exp_700',  # lead=42
#     'exp_8/exp_800',  # lead=49
#     'exp_9/exp_900',  # lead=56
#     'ERA5/exp_1000'   # lead=21, ERA5
# ]

NLABEL = 2

# Local directories
ddir_X = "/gpfs/home4/tleneman/Data/Processed_cesm2/"
...
# Function for days_average (for compatibility with model2_snellius.py)
def apply_averaging(data, days):
    # Simple moving average (assuming data is [samples, features])
    if data.ndim == 1:
...
# Model definition functions (from paper)
    ...
    for seed in random_seeds:
        for lead in lead_times:
            ...
            history = model.fit(
                ...
                callbacks=[
                    tf.keras.callbacks.EarlyStopping(patience=exp_settings['PATIENCE'], restore_best_weights=True),
