#!/bin/bash
#SBATCH --job-name=model2_conda
#SBATCH --output=/gpfs/home4/tleneman/Data/Processed_cesm2_3day/logs/model2_conda_%A_%a.out
#SBATCH --error=/gpfs/home4/tleneman/Data/Processed_cesm2_3day/logs/model2_conda_%A_%a.err
...
# List of experiments
experiments=("exp_2/exp_200" "exp_3/exp_300" "exp_4/exp_400" "exp_5/exp_500" "exp_6/exp_600" "exp_7/exp_700" "exp_8/exp_800")
...
# Run the script
/home/tleneman/.conda/envs/tf-env/bin/python /gpfs/home4/tleneman/model2_prototype2.py "$EXPERIMENT"
